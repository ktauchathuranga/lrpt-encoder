...
fn ac_huffman_encode(run: u8, category: u8) -> (u32, u8) {
    // Standard JPEG AC luminance Huffman table
    ...
    match symbol {
        ...
        0x43 => (0b111111110110, 12),
        0x44 => (0b1111111110010110, 16),
        0x45 => (0b1111111110010111, 16),
        0x46 => (0b1111111110011000, 16),
        0x47 => (0b1111111110011001, 16),
        0x48 => (0b1111111110011010, 16),
        0x49 => (0b1111111110011011, 16),
        0x4A => (0b1111111110011100, 16),
        0x51 => (0b1111010, 7),
        0x52 => (0b11111110111, 11),
        0x53 => (0b111111110111, 12),
        0x54 => (0b1111111110011101, 16),
        0x55 => (0b1111111110011110, 16),
        0x56 => (0b1111111110011111, 16),
        0x57 => (0b1111111110100000, 16),
        0x58 => (0b1111111110100001, 16),
        0x59 => (0b1111111110100010, 16),
        0x5A => (0b1111111110100011, 16),
        0x61 => (0b1111011, 7),
        0x62 => (0b111111111000000, 15),
        0x63 => (0b1111111110100100, 16),
        0x64 => (0b1111111110100101, 16),
        0x65 => (0b1111111110100110, 16),
        0x66 => (0b1111111110100111, 16),
        0x67 => (0b1111111110101000, 16),
        0x68 => (0b1111111110101001, 16),
        0x69 => (0b1111111110101010, 16),
        0x6A => (0b1111111110101011, 16),
        0x71 => (0b11111010, 8),
        0x72 => (0b111111111000001, 15),
        0x73 => (0b1111111110101100, 16),
        0x74 => (0b1111111110101101, 16),
        0x75 => (0b1111111110101110, 16),
        0x76 => (0b1111111110101111, 16),
        0x77 => (0b1111111110110000, 16),
        0x78 => (0b1111111110110001, 16),
        0x79 => (0b1111111110110010, 16),
        0x7A => (0b1111111110110011, 16),
        0x81 => (0b11111011, 8),
        0x82 => (0b1111111110110100, 16),
        0x83 => (0b1111111110110101, 16),
        0x84 => (0b1111111110110110, 16),
        0x85 => (0b1111111110110111, 16),
        0x86 => (0b1111111110111000, 16),
        0x87 => (0b1111111110111001, 16),
        0x88 => (0b1111111110111010, 16),
        0x89 => (0b1111111110111011, 16),
        0x8A => (0b1111111110111100, 16),
        0x91 => (0b111111000, 9),
        0x92 => (0b1111111110111101, 16),
        0x93 => (0b1111111110111110, 16),
        0x94 => (0b1111111110111111, 16),
        0x95 => (0b1111111111000000, 16),
        0x96 => (0b1111111111000001, 16),
        0x97 => (0b1111111111000010, 16),
        0x98 => (0b1111111111000011, 16),
        0x99 => (0b1111111111000100, 16),
        0x9A => (0b1111111111000101, 16),
        0xA1 => (0b111111001, 9),
        0xA2 => (0b1111111111000110, 16),
        0xA3 => (0b1111111111000111, 16),
        0xA4 => (0b1111111111001000, 16),
        0xA5 => (0b1111111111001001, 16),
        0xA6 => (0b1111111111001010, 16),
        0xA7 => (0b1111111111001011, 16),
        0xA8 => (0b1111111111001100, 16),
        0xA9 => (0b1111111111001101, 16),
        0xAA => (0b1111111111001110, 16),
        0xB1 => (0b111111010, 9),
        0xB2 => (0b1111111111001111, 16),
        0xB3 => (0b1111111111010000, 16),
        0xB4 => (0b1111111111010001, 16),
        0xB5 => (0b1111111111010010, 16),
        0xB6 => (0b1111111111010011, 16),
        0xB7 => (0b1111111111010100, 16),
        0xB8 => (0b1111111111010101, 16),
        0xB9 => (0b1111111111010110, 16),
        0xBA => (0b1111111111010111, 16),
        0xC1 => (0b1111111010, 10),
        0xC2 => (0b1111111111011000, 16),
        0xC3 => (0b1111111111011001, 16),
        0xC4 => (0b1111111111011010, 16),
        0xC5 => (0b1111111111011011, 16),
        0xC6 => (0b1111111111011100, 16),
        0xC7 => (0b1111111111011101, 16),
        0xC8 => (0b1111111111011110, 16),
        0xC9 => (0b1111111111011111, 16),
        0xCA => (0b1111111111100000, 16),
        0xD1 => (0b1111111011, 10),
        0xD2 => (0b1111111111100001, 16),
        0xD3 => (0b1111111111100010, 16),
        0xD4 => (0b1111111111100011, 16),
        0xD5 => (0b1111111111100100, 16),
        0xD6 => (0b1111111111100101, 16),
        0xD7 => (0b1111111111100110, 16),
        0xD8 => (0b1111111111100111, 16),
        0xD9 => (0b1111111111101000, 16),
        0xDA => (0b1111111111101001, 16),
        0xE1 => (0b11111111000, 11),
        0xE2 => (0b1111111111101010, 16),
        0xE3 => (0b1111111111101011, 16),
        0xE4 => (0b1111111111101100, 16),
        0xE5 => (0b1111111111101101, 16),
        0xE6 => (0b1111111111101110, 16),
        0xE7 => (0b1111111111101111, 16),
        0xE8 => (0b1111111111110000, 16),
        0xE9 => (0b1111111111110001, 16),
        0xEA => (0b1111111111110010, 16),
        0xF0 => (0b11111111001, 11),     // ZRL (16 zeros)
        0xF1 => (0b1111111111110011, 16),
        0xF2 => (0b1111111111110100, 16),
        0xF3 => (0b1111111111110101, 16),
        0xF4 => (0b1111111111110110, 16),
        0xF5 => (0b1111111111110111, 16),
        0xF6 => (0b1111111111111000, 16),
        0xF7 => (0b1111111111111001, 16),
        0xF8 => (0b1111111111111010, 16),
        0xF9 => (0b1111111111111011, 16),
        0xFA => (0b1111111111111100, 16),
